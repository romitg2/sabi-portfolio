...
export const Hero = () => {
  return (
    <div className="relative">
      <div className="absolute top-[40vh] left-[7vw] ">
        <p className=" text-blue-500 tracking-tight text-[8vh]">Welcome, </p>
        <div className="flex gap-x-8">
          <p className="text-blue-500 mt-[-4vh] tracking-tight text-[12vh]">
        ...
        <p>
          ...
          qui minim labore adipisicing minim <br />
