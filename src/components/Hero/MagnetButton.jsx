...
export const MagnetButtonExample = () => {
  return (
...
const MagnetButton = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative grid h-[12vh] w-[12vh] place-content-center rounded-full border-2 border-black transition-colors duration-700 ease-out"
    >
      ...
      >
        ...
        <text>
          <textPath
            href="#circlePath"
            fill="black"
            className="fill-black text-sm font-light tracking-[0.13em] uppercase opacity-0 transition-opacity duration-700 ease-out group-hover:opacity-100"
          >
            TEXTILE DESIGNER - "Elevating threads into timeless artistry" -
          </textPath>
        </text>
      </motion.svg>
    </motion.button>
